  ...
  mood: {
    ...
    ambience: [
      ...
      },
      {
        id: 'tavern-rain',
        name: 'Rain Outside',
        audioSrc: '/audio/ambience-rain.mp3',
        icon: CloudRain,
      },
      {
        id: 'tavern-music',
        name: 'Bard Music',
        audioSrc: '/audio/ambience-tavern.mp3',
        icon: Volume2,
      },
    ],
    effects: [
      ...
      { id: 'tavern-bell', name: 'Bell Ring', audioSrc: '/audio/sfx-bell.mp3', icon: Bell },
      {
        id: 'tavern-steps',
        name: 'Footprints',
        audioSrc: '/audio/sfx-footsteps.mp3',
        icon: Footprints,
      },
  ...
  mood: {
    ...
    ambience: [
      ...
      { id: 'combat-fire', name: 'Fires', audioSrc: '/audio/ambience-campfire.mp3', icon: Flame },
      {
        id: 'combat-march',
        name: 'Marching',
        audioSrc: '/audio/ambience-march.mp3',
        icon: Footprints,
      },
    ],
    effects: [
  ...
  mood: {
    ...
    effects: [
      ...
      { id: 'dungeon-ghost', name: 'Whispers', audioSrc: '/audio/sfx-whisper.mp3', icon: Ghost },
      {
        id: 'dungeon-collapse',
        name: 'Collapse',
        audioSrc: '/audio/sfx-collapse.mp3',
        icon: Mountain,
      },
    ],
  },
  ...
  mood: {
    ...
    ambience: [
      {
        id: 'haunted-wind',
        name: 'Howling Wind',
        audioSrc: '/audio/ambience-wind.mp3',
        icon: Wind,
      },
      { id: 'haunted-creak', name: 'Creaking', audioSrc: '/audio/ambience-creak.mp3', icon: Store },
      {
        id: 'haunted-whisper',
        name: 'Whispers',
        audioSrc: '/audio/ambience-whisper.mp3',
        icon: Ghost,
      },
    ...
    effects: [
      { id: 'haunted-scream', name: 'Scream', audioSrc: '/audio/sfx-scream.mp3', icon: Skull },
      {
        id: 'haunted-door',
        name: 'Door Creak',
        audioSrc: '/audio/sfx-door-creak.mp3',
        icon: Store,
      },
      ...
      { id: 'haunted-glass', name: 'Glass Break', audioSrc: '/audio/sfx-glass.mp3', icon: Zap },
      {
        id: 'haunted-laugh',
        name: 'Evil Laugh',
        audioSrc: '/audio/sfx-evil-laugh.mp3',
        icon: Skull,
      },
      {
        id: 'haunted-steps',
  ...
  mood: {
    ...
    ambience: [
      { id: 'winter-wind', name: 'Cold Wind', audioSrc: '/audio/ambience-wind.mp3', icon: Wind },
      {
        id: 'winter-snow',
        name: 'Snowfall',
        audioSrc: '/audio/ambience-snow.mp3',
        icon: Snowflake,
      },
    ...
    effects: [
      {
        id: 'winter-crunch',
        name: 'Snow Crunch',
        audioSrc: '/audio/sfx-snow.mp3',
        icon: Footprints,
      },
      {
        id: 'winter-avalanche',
        name: 'Avalanche',
        audioSrc: '/audio/sfx-avalanche.mp3',
        icon: Mountain,
      },
      {
        id: 'winter-crack',
        name: 'Ice Crack',
        audioSrc: '/audio/sfx-ice-crack.mp3',
        icon: Snowflake,
      },
  ...
  mood: {
    ...
    ambience: [
      { id: 'market-crowd', name: 'Crowd', audioSrc: '/audio/ambience-crowd.mp3', icon: Store },
      {
        id: 'market-music',
        name: 'Street Music',
        audioSrc: '/audio/ambience-music.mp3',
        icon: Volume2,
      },
